...
class LaporanModel extends Model
{
    ...
    protected $allowedFields = [
        'kode_laporan', 'pelapor_id', 'kategori_id', 'judul_laporan',
    ...
    // Join dengan tabel relasi untuk mendapatkan nama kategori & pelapor
    public function getLaporanWithRelations($id = null)
    {
        $builder = $this->db->table('laporan l')
            ->select('l.*, p.nama_pelapor, p.nik, p.no_telepon, k.nama_kategori')
