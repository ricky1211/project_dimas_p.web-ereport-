            ...
            <div class="bg-white rounded-3xl shadow-2xl p-8">
                ...
                <div class="space-y-4">
                    ...
                    <button
                        @click="doLogin"
                        :disabled="loading"
                        class="w-full bg-blue-700 hover:bg-blue-800 disabled:bg-blue-400 text-white font-bold py-3 rounded-xl transition-all shadow-lg hover:shadow-blue-300 text-sm">
                ...
                <div class="text-center mt-6">
                    <router-link to="/" class="text-blue-600 text-sm hover:underline">
                        ← Kembali ke Beranda
                    </router-link>
                </div>
