        ...
        <aside class="w-64 bg-blue-900 min-h-screen flex flex-col fixed left-0 top-0 shadow-2xl z-40">
            <div class="p-6 border-b border-blue-800">
                <div class="flex items-center space-x-3">
                    ...
                    <div><p class="text-white font-bold text-sm">E-Report</p><p class="text-blue-300 text-xs">Admin Panel</p></div>
                </div>
            </div>
            <div class="px-4 py-4 border-b border-blue-800">
                <div class="bg-blue-800 rounded-xl p-3">
                    ...
                    <p class="text-blue-300 text-xs">{{ user.role }}</p>
                </div>
            </div>
            <nav class="flex-1 p-4 space-y-1">
                <router-link to="/dashboard" class="flex items-center space-x-3 px-4 py-3 rounded-xl text-blue-200 hover:bg-blue-800 hover:text-white transition-colors text-sm font-medium" active-class="bg-blue-700 text-white"><span>📊</span><span>Dashboard</span></router-link>
                <router-link to="/laporan" class="flex items-center space-x-3 px-4 py-3 rounded-xl text-blue-200 hover:bg-blue-800 hover:text-white transition-colors text-sm font-medium" active-class="bg-blue-700 text-white"><span>📋</span><span>Laporan Pengaduan</span></router-link>
                <router-link to="/kategori" class="flex items-center space-x-3 px-4 py-3 rounded-xl text-blue-200 hover:bg-blue-800 hover:text-white transition-colors text-sm font-medium" active-class="bg-blue-700 text-white"><span>🏷️</span><span>Kategori Aduan</span></router-link>
                <router-link to="/pelapor" class="flex items-center space-x-3 px-4 py-3 rounded-xl text-blue-200 hover:bg-blue-800 hover:text-white transition-colors text-sm font-medium" active-class="bg-blue-700 text-white"><span>👥</span><span>Data Pelapor</span></router-link>
            </nav>
            <div class="p-4">
                <button @click="doLogout" class="w-full flex items-center justify-center space-x-2 bg-red-600 hover:bg-red-700 text-white px-4 py-3 rounded-xl transition-colors text-sm font-semibold">
